...
import com.shimhg02.solorestorant.Test.Adapter.TestRecommendData
...
class TestFragment : Fragment() { //프레그먼트를 띄우기 위해 주로 사용합니다.
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val testDataList = arrayListOf( //테스트용 더미데이터1
            ...
            TestData("이민혁", "https://lh3.googleusercontent.com/proxy/qBjp0UbVFfArGEBTr_tXnwar4UxIlVWn1laTjb9Liot9FHuY7JFZabCMKKVPcbRseGUQBiR0HLtuu1AOmqr5js5Tcua_WNW_ijXett_BJG1svWhQ4lIXBI8Rx88RA3IOMZQaxuqOkbAdepAA2iL6uIkW7je02lbWiSQR0kZfUHeO6wA", "https://i.pinimg.com/originals/4f/49/53/4f4953b636a8bb4377fe8ddf3f37bb5f.jpg"),
            TestData("임수민", "https://i.pinimg.com/originals/3a/97/b1/3a97b1ff7ba1338dda57533416a6d08f.png", "https://pbs.twimg.com/media/EKSPb2RU0AAr9g6.jpg"),
            TestData("박종훈", "https://pbs.twimg.com/media/ERo04MOU0AATugV.jpg", "https://i.pinimg.com/originals/49/72/d4/4972d4c65f3b1ebdeda26bd2b524ea33.jpg")
        )

        val recommendTestDataList = arrayListOf( //테스트용 더미데이터2
            TestRecommendData("람다람","킹갓람다람", "https://s3.marpple.co/files/u_14345/2020/4/original/2144663c7991a33e33469e2d23a25591e1cd47e568e767c.png"),
            TestRecommendData("람다람","람다람일러좋아" ,"https://cdn.class101.net/images/8062f865-c1ec-459c-b3f6-3d67a928cda7/1200x630")
        )

        val recommendTestDataList2 = arrayListOf( //테스트용 더미데이터3
            TestRecommendData("람다람","람다람 넣을게~" , "https://steamuserimages-a.akamaihd.net/ugc/781851765958068828/D4B37575DDB625FFAF9E6D81D5DB43F622D23E51/?imw=512&&ima=fit&impolicy=Letterbox&imcolor=%23000000&letterbox=false"),
            TestRecommendData("람다람","람다람 왜 울고있는거야?" ,"https://cdn.class101.net/images/0c204339-b159-45c9-bf28-1335bb48125f/1200xauto")
        )
